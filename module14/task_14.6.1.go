...
func intersectionWithDoubles(inputArr1, inputArr2 []int) (result []int) {
...
func intersectionWithOutDoubles(inputArr1, inputArr2 []int) (result []int) {
...
func fillArray(size int) (arr []int) {
